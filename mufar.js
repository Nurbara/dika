...
// Wadefak Men
const fmen = { key : { participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 2021, status: 1, surface : 1, message: `© Dika Bot`, thumbnail: fs.readFileSync('./src/Mufar.jpg'), sellerJid: '0@s.whatsapp.net'}}}
const fdoc = { key: { participant : '0@s.whatsapp.net'}, message: {documentMessage: {title: `© Dika Bot`, jpegThumbnail: thumb}}}
...
const fgif = { key: { participant: '0@s.whatsapp.net', ...(from ? { remoteJid: "6283871990243-1613049930@g.us" } : {})}, message: {"videoMessage": { "title":`© Dika Bot`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `© Dika Bot`, 'jpegThumbnail': thumb}}}
const fgclink = { key: { participant: '0@s.whatsapp.net', "remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6283871990243-1616169743@g.us","inviteCode": "m","groupName": "Dika Bot", "caption": `© Dika Bot`, 'jpegThumbnail': thumb}}}
const fvideo = { key: { fromMe: false, participant: '0@s.whatsapp.net', ...(from ? { remoteJid: "6283871990243-1613049930@g.us" } : {})}, message: { "videoMessage": { "title":`© Dika Bot`, "h": `Hmm`,'seconds': '99999', 'caption': `© Dika Bot`, 'jpegThumbnail': thumb}}}
const floc = { key: { participant : '0@s.whatsapp.net'}, message: {locationMessage: {name: `© Dika Bot`, jpegThumbnail: thumbz}}}
...
{ buttonId: `${prefix}owner`, buttonText: { displayText: 'Creator ʙᴏᴛᴢᴢ ᴍᴇᴇ' }, type: 1 }
]
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
nama = 'ʙᴏᴛᴢᴢ ᴍᴇᴇ'
ownerJid = "6283174508962@s.whatsapp.net"
...
gbutsan = [
{buttonId:`owner`, buttonText:{displayText: 'Creator ʙᴏᴛᴢᴢ ᴍᴇᴇ'}, type:1},
...
footerText: '*_© Dika Bot_*',
description: `${tampilUcapan} ${pushname}, *Hallo User @${sender.split('@')[0]}, Silahkan pilih menu disini*`,
sections: [
                 {
                 "title": `${week}, ${calender}`,
 rows: [
...
case 'rulesbot':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
ruls =`*Syarat & Ketentuan ʙᴏᴛᴢᴢ ᴍᴇᴇ*
...
*Silahkan lanjut gunakan ʙᴏᴛᴢᴢ ᴍᴇᴇ*`
...
members_ids.push(mem.jid)
            ...
            + 'END:VCARD'.trim()
            Mufar.sendMessage(from, {displayName: `𝘽𝙖𝙧𝙖`, vcard: vcard2}, contact, 
            { quoted: fmen, 
            })
            replyWithFakeLink('*Ini Nomor Owner ʙᴏᴛᴢᴢ ᴍᴇᴇ*\nMau Chat? Utamakan Salam!')
            limitAdd(sender, limit)
            break
...
sendButton(from, "https://github.com/Nurbara/Bara-V1", faketeks, but, mek)
limitAdd(sender, limit)
lbreak
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
if (isLimit(sender, isPrem, isOwner, limitawal, limit)) return reply(mess.limit)
if (args.length == 0) return reply(`Example: ${prefix + command} Dika Bot`)
mf4r = args.join(" ")
buffer = await getBuffer(`https://api.lolhuman.xyz/api/tweettrump?apikey=${lolkey}&text=${mf4r}`)
Mufar.sendMessage(from, buffer, image, {quoted: mek, caption: '*© Dika Bot*'})
limitAdd(sender, limit)
break
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fmen})
if (isLimit(sender, isPrem, isOwner, limitawal, limit)) return reply(mess.limit)
if (args.length == 0) return reply(`Usage: ${prefix + command} query\nExample: ${prefix + command} Dika Bot`)
username = args[0]
comment = args[2]
